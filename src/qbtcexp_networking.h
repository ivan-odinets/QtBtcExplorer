...
#ifndef QT_BTCEXPLORER_NETWORKING_H
#define QT_BTCEXPLORER_NETWORKING_H
...
/*! @class Networking qtbtcexp_networking.h
 *  @brief This class a bit simplifies communication with btc-rpc-explorer server.
...
protected:
    ...
    QString        apiHost() const                         { return m_host; }

    QByteArray     get(const QString& urlPart);
...
#endif // QT_BTCEXPLORER_NETWORKING_H
